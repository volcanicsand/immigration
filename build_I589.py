"""
Run once: py build_I589.py
Generates I-589_Wizard.html -- a fully self-contained file you can
double-click to open. No server, no Python needed after this.
"""
import base64, os

PDF_PATH = r'C:\Users\johnh\uscis_forms\I-589.pdf'
OUT_PATH = r'C:\Users\johnh\immigration\I-589_Wizard.html'
...
tmpl_path = os.path.join(os.path.dirname(__file__), 'I-589_wizard_template.html')
